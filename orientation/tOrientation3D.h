...
class tOrientation<3, TElement, TSIUnit> : public orientation::tOrientationBase<3, TElement, TSIUnit>
{
  typedef orientation::tOrientationBase<3, TElement, TSIUnit> tOrientationBase;
...
public:
  ...
  tOrientation(const tOrientation<3, TOtherElement, TSIUnit> &other);
  ...
  template <typename TOtherElement>
  tOrientation &operator += (const tOrientation<3, TOtherElement, TSIUnit> &other);
...
template <typename TElement, typename TSIUnit>
bool IsEqual(const tOrientation<3, TElement, TSIUnit> &left, const tOrientation<3, TElement, TSIUnit> &right, float max_error = 1E-6, math::tFloatComparisonMethod method = math::eFCM_ABSOLUTE_ERROR);
