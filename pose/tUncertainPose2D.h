...
class tUncertainPose<2, TElement, TPositionSIUnit, TOrientationSIUnit> : public pose::tUncertainPoseBase<2, TElement, TPositionSIUnit, TOrientationSIUnit>
{
  typedef pose::tUncertainPoseBase<2, TElement, TPositionSIUnit, TOrientationSIUnit> tPoseBase;
